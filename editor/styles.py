...
class LightTheme:
    text           = QColor("#1f2c39")
    text_inactive  = QColor("#a3b2c2")
    hl_text_bg     = QColor("#3677e0")
    primary_bg     = QColor("#cfd5db")
    secondary_bg   = QColor("#E3E3E3")
    ...
    signal_high    = QColor("#3a9e60")
    signal_low     = QColor("#91AB99")
    signal_error   = QColor("#FF1E1E")
    signal_unknown = QColor("#414ABA")
    
    pin_high       = QColor("#3a9e60")
