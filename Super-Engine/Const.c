...
enum  {
  ...
  __pyx_e_5Const_NOT = 0,
  __pyx_e_5Const_AND = 1,
  __pyx_e_5Const_NAND = 2,
  __pyx_e_5Const_OR = 3,
  __pyx_e_5Const_NOR = 4,
  __pyx_e_5Const_XOR = 5,
  __pyx_e_5Const_XNOR = 6,
  __pyx_e_5Const_VARIABLE = 7,
  __pyx_e_5Const_PROBE = 8,
  __pyx_e_5Const_INPUT_PIN = 9,
  __pyx_e_5Const_OUTPUT_PIN = 10,
  __pyx_e_5Const_IC = 11,
...
#define __pyx_n_u_MODE __pyx_string_tab[1]
 ...
 * 
*/
  __pyx_t_2 = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_DESIGN); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_MODE, __pyx_t_2) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
...
*/
  ...
  /*--- Wrapped vars code ---*/
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_ADD);
    if (unlikely(!wrapped)) __PYX_ERR(0, 12, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "ADD", wrapped) < 0) __PYX_ERR(0, 12, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_AND);
    if (unlikely(!wrapped)) __PYX_ERR(0, 24, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "AND", wrapped) < 0) __PYX_ERR(0, 24, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_CONNECT);
    if (unlikely(!wrapped)) __PYX_ERR(0, 14, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "CONNECT", wrapped) < 0) __PYX_ERR(0, 14, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_DELETE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 13, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "DELETE", wrapped) < 0) __PYX_ERR(0, 13, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_DESIGN);
    if (unlikely(!wrapped)) __PYX_ERR(0, 8, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "DESIGN", wrapped) < 0) __PYX_ERR(0, 8, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_DISCONNECT);
    if (unlikely(!wrapped)) __PYX_ERR(0, 15, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "DISCONNECT", wrapped) < 0) __PYX_ERR(0, 15, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_ERROR);
    if (unlikely(!wrapped)) __PYX_ERR(0, 5, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "ERROR", wrapped) < 0) __PYX_ERR(0, 5, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_FLIPFLOP);
    if (unlikely(!wrapped)) __PYX_ERR(0, 10, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "FLIPFLOP", wrapped) < 0) __PYX_ERR(0, 10, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_HIGH);
    if (unlikely(!wrapped)) __PYX_ERR(0, 3, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "HIGH", wrapped) < 0) __PYX_ERR(0, 3, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_IC);
    if (unlikely(!wrapped)) __PYX_ERR(0, 34, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "IC", wrapped) < 0) __PYX_ERR(0, 34, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_INPUT_PIN);
    if (unlikely(!wrapped)) __PYX_ERR(0, 32, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "INPUT_PIN", wrapped) < 0) __PYX_ERR(0, 32, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_LIMIT);
    if (unlikely(!wrapped)) __PYX_ERR(0, 20, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "LIMIT", wrapped) < 0) __PYX_ERR(0, 20, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_LOW);
    if (unlikely(!wrapped)) __PYX_ERR(0, 4, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "LOW", wrapped) < 0) __PYX_ERR(0, 4, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_NAND);
    if (unlikely(!wrapped)) __PYX_ERR(0, 25, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "NAND", wrapped) < 0) __PYX_ERR(0, 25, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_NOR);
    if (unlikely(!wrapped)) __PYX_ERR(0, 27, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "NOR", wrapped) < 0) __PYX_ERR(0, 27, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_NOT);
    if (unlikely(!wrapped)) __PYX_ERR(0, 23, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "NOT", wrapped) < 0) __PYX_ERR(0, 23, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_OR);
    if (unlikely(!wrapped)) __PYX_ERR(0, 26, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "OR", wrapped) < 0) __PYX_ERR(0, 26, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_OUTPUT_PIN);
    if (unlikely(!wrapped)) __PYX_ERR(0, 33, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "OUTPUT_PIN", wrapped) < 0) __PYX_ERR(0, 33, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_PASTE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 16, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "PASTE", wrapped) < 0) __PYX_ERR(0, 16, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_PROBE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 31, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "PROBE", wrapped) < 0) __PYX_ERR(0, 31, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_SETLIMITS);
    if (unlikely(!wrapped)) __PYX_ERR(0, 18, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "SETLIMITS", wrapped) < 0) __PYX_ERR(0, 18, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_SIMULATE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 9, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "SIMULATE", wrapped) < 0) __PYX_ERR(0, 9, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_TOGGLE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 17, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "TOGGLE", wrapped) < 0) __PYX_ERR(0, 17, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_TOTAL);
    if (unlikely(!wrapped)) __PYX_ERR(0, 35, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "TOTAL", wrapped) < 0) __PYX_ERR(0, 35, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_UNKNOWN);
    if (unlikely(!wrapped)) __PYX_ERR(0, 6, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "UNKNOWN", wrapped) < 0) __PYX_ERR(0, 6, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_VARIABLE);
    if (unlikely(!wrapped)) __PYX_ERR(0, 30, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "VARIABLE", wrapped) < 0) __PYX_ERR(0, 30, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_XNOR);
    if (unlikely(!wrapped)) __PYX_ERR(0, 29, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "XNOR", wrapped) < 0) __PYX_ERR(0, 29, __pyx_L1_error);
  }
  {
    PyObject* wrapped = __Pyx_PyLong_From___pyx_anon_enum(__pyx_e_5Const_XOR);
    if (unlikely(!wrapped)) __PYX_ERR(0, 28, __pyx_L1_error)
    if (PyObject_SetAttrString(__pyx_m, "XOR", wrapped) < 0) __PYX_ERR(0, 28, __pyx_L1_error);
  }
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{4},{18},{8},{10},{8},{12},{10},{8}};
const char* const bytes = "?MODEcline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
